...
import type {
  Lease,
  LeaseInterface,
} from "../../../../contracts/token/modules/Lease";
...
export class Lease__factory {
  static readonly abi = _abi;
  static createInterface(): LeaseInterface {
    return new utils.Interface(_abi) as LeaseInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Lease {
    return new Contract(address, _abi, signerOrProvider) as Lease;
  }
}
